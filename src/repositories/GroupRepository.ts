...
export const GroupRepository = {
  all: function (params: any = null) {
    return api.get(`${endPoint()}/v1/group`, {
      params,
      cancelToken:
  ...
  show: function (id: number | string, params: any = null) {
    return api.get(`${endPoint()}/v1/group/${id}`, {
      params,
      cancelToken:
  ...
  create: function (payload: any, params: any = null) {
    return api.post(`${endPoint()}/v1/group`, payload, {
      params,
      cancelToken:
  ...
  update: function (id: number | string, payload: any, params: any = null) {
    return api.put(`${endPoint()}/v1/group/${id}`, payload, {
      params,
      cancelToken:
  ...
  delete: function (id: number | string, params: any = null) {
    return api.delete(`${endPoint()}/v1/group/${id}`, {
      params,
      cancelToken:
